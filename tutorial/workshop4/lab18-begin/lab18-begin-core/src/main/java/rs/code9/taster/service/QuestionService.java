...
public interface QuestionService extends CrudService<Question> {
	 ...
	 * 
	 * @param question the question to which new answer is added
	 */
	 ...
	 * 
	 * @param question the question from which the answer is removed
	 * @param answerId the id of the answer that is removed
	 * @throws IllegalArgumentException thrown when no answer with provided id is found
	 */
	void removeAnswer(Question question, Long answerId) throws IllegalArgumentException;
}
