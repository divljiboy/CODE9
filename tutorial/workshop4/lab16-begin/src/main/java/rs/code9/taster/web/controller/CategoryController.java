...
public class CategoryController {
	...
	/**
	 * Retrieves all categories and returns them as model attribute <code>categories</code>.
	 * 
	 * @return list of all categories, as model attribute <code>categories</code>
	 */
	...
	/**
	 * Returns the view for adding new category. Adds empty category as model attribute <code>category</code>.
	 * 
	...
	/**
	 * Returns the view for editing a category. Adds category, found by passed id, as model attribute
	 * <code>category</code>.
	 * 
	...
	public String post(@Valid Category category, BindingResult bindingResult, Model model) {
		String viewName;
		if (!bindingResult.hasErrors()) {
			categoryService.save(category);
			viewName = "redirect:categories";
		} else {
			model.addAttribute("category", category);
			viewName = "addEditCategory";
		}
		return viewName;
	}
