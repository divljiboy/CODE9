	...
	<body>
		<header>
			<div class="top darkNoise">
				<a href="http://www.levi9.com/" target="_blank"><fmt:message key="common.header.link"/></a>
			...
			<ul id="mainMenu">
				<li class="highlightcolorBlack"><a class="dashBoard" href="<c:url value="/home"/>"><fmt:message key="common.menu.dashboard"/></a></li>
				<sec:authorize access="hasRole('ROLE_ADMIN')">
				    <li class="highlightcolorBlack"><a class="categories" href="<c:url value="/categories"/>"><fmt:message key="common.menu.categories"/></a></li>
				    <li class="highlightcolorBlack"><a class="questions" href="<c:url value="/questions"/>"><fmt:message key="common.menu.questions"/></a></li>
				</sec:authorize>
				<li class="highlightcolorBlack"><a class="testTemplates" href="<c:url value="/tests"/>"><fmt:message key="common.menu.tests"/></a></li>
				<%-- <li class="highlightcolorBlack"><a class="start" href="#"><fmt:message key="common.menu.startTest"/></a></li> --%>
			</ul>
		</header>
