...
public class AbstractInMemoryServiceTest {
	...
	/**
	 * Test method - {@link AbstractInMemoryService#getOne(Long)}.
	 */
	@Test
	public void testFindOne() {
		NamedEntity e1 = service.getOne(1L);
	...
	public void testSave() {
		...
		Assert.assertEquals("New NamedEntity", service.getOne(saved.getId()).name);
	}
	...
	public void testRemove() {
		Assert.assertNotNull(service.getOne(1L));
		Assert.assertNotNull(service.getOne(2L));

		service.remove(1L);

		Assert.assertNull(service.getOne(1L));
		Assert.assertNotNull(service.getOne(2L));
	}
	...
	public void testRemoveIllegalArgument() {
		Assert.assertNull(service.getOne(3L));
		service.remove(3L);
	}
}
