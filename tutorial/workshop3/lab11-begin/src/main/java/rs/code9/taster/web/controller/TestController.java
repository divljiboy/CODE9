...
public class TestController {
	...
	/**
	 * Returns the view for adding new test. Adds empty test as model
	 * attribute <code>test</code>.
	 * 
	 * @param model
	...
	/**
	 * Returns the view for editing a test. Adds test, found by passed id,
	 * as model attribute <code>test</code>.
	 * 
	 * @param id
